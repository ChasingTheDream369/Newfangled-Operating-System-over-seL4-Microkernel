...
static seL4_CPtr file_server_ntfn;
...
void network_init(cspace_t *cspace, void *timer_vaddr, seL4_CPtr irq_ntfn, seL4_CPtr file_server_ntfn_arg, seL4_CPtr load_ntfn)
{
    int error;
    ZF_LOGI("\nInitialising network...\n\n");

    file_server_ntfn = file_server_ntfn_arg;
    ...
    int ret = nfs_mount_async(nfs, CONFIG_SOS_GATEWAY, nfs_dir_buf, nfs_mount_cb, (void *)load_ntfn);
